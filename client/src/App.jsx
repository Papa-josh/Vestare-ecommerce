  ...
  return (
    <div className="flex flex-col overflow-hidden bg-white">
      ...
      <Routes>
        ...
        />
        {/* This path "/auth" is always common so that we created a common layout, and the advantage is that you don't need to write more layout code (components/auth/layout.jsx/AuthLayout)  every time in all the pages*/}
        <Route
          path="/auth"
          element={
            // This is to protect the route and base on the role
